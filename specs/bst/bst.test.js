...
class Node {
  ...
  add(value) {
    ...
    if (!this.left && value <= this.value) this.left = child;
    else if (!this.right && value > this.value) this.right = child;
    else if (this.left && value <= this.value) this.left.add(child.value);
    else if (this.right && value > this.value) this.right.add(child.value);
  }
}
